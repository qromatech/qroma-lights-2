...
const config = {
  ...
  baseUrl: '/qroma-lights-2/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'qroma-lights-2', // Usually your GitHub org/user name.
  projectName: 'qroma-lights-2', // Usually your repo name.
  ...
  scripts: [
    ...
    {
      src: '/qroma-lights-2/esp-web-tools/install-button.js?module',
      async: true,
    },
  ],
