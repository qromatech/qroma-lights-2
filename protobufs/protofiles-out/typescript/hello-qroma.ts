...
export interface MyAppCommand {
    ...
    command: {
        ...
        /**
         * @generated from protobuf field: HelloQromaRequest helloQromaRequest = 1;
         */
        helloQromaRequest: HelloQromaRequest;
    } | {
        oneofKind: "mathRequest";
        /**
         * @generated from protobuf field: MathRequest mathRequest = 2;
         */
        ...
        /**
         * @generated from protobuf field: SetUpdateProgressIndicator setUpdateProgressIndicator = 4;
         */
...
export interface MyAppResponse {
    ...
    response: {
        ...
        /**
         * @generated from protobuf field: HelloQromaResponse helloQromaResponse = 1;
         */
        helloQromaResponse: HelloQromaResponse;
    } | {
        oneofKind: "mathResponse";
        /**
         * @generated from protobuf field: MathResponse mathResponse = 2;
         */
        mathResponse: MathResponse;
    } | {
        oneofKind: "setUpdateConfigurationResponse";
        /**
         * @generated from protobuf field: SetUpdateConfigurationResponse setUpdateConfigurationResponse = 3;
         */
        setUpdateConfigurationResponse: SetUpdateConfigurationResponse;
    } | {
        oneofKind: "setUpdateProgressIndicatorResponse";
        /**
         * @generated from protobuf field: SetUpdateProgressIndicatorResponse setUpdateProgressIndicatorResponse = 4;
         */
...
class MyAppCommand$Type extends MessageType<MyAppCommand> {
    constructor() {
        super("MyAppCommand", [
            { no: 1, name: "helloQromaRequest", kind: "message", oneof: "command", T: () => HelloQromaRequest },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MyAppCommand): MyAppCommand {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* HelloQromaRequest helloQromaRequest */ 1:
                    message.command = {
                        oneofKind: "helloQromaRequest",
                    ...
                    break;
                case /* MathRequest mathRequest */ 2:
                    message.command = {
                        oneofKind: "mathRequest",
                ...
                case /* SetUpdateConfiguration setUpdateConfiguration */ 3:
                    ...
                    break;
                case /* SetUpdateProgressIndicator setUpdateProgressIndicator */ 4:
                    message.command = {
                        oneofKind: "setUpdateProgressIndicator",
    ...
    internalBinaryWrite(message: MyAppCommand, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.command.oneofKind === "helloQromaRequest")
            HelloQromaRequest.internalBinaryWrite(message.command.helloQromaRequest, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* MathRequest mathRequest = 2; */
        if (message.command.oneofKind === "mathRequest")
            MathRequest.internalBinaryWrite(message.command.mathRequest, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.command.oneofKind === "setUpdateProgressIndicator")
            SetUpdateProgressIndicator.internalBinaryWrite(message.command.setUpdateProgressIndicator, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
...
class MyAppResponse$Type extends MessageType<MyAppResponse> {
    constructor() {
        super("MyAppResponse", [
            { no: 1, name: "helloQromaResponse", kind: "message", oneof: "response", T: () => HelloQromaResponse },
            { no: 2, name: "mathResponse", kind: "message", oneof: "response", T: () => MathResponse },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MyAppResponse): MyAppResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* HelloQromaResponse helloQromaResponse */ 1:
                    message.response = {
                        oneofKind: "helloQromaResponse",
                ...
                case /* SetUpdateConfigurationResponse setUpdateConfigurationResponse */ 3:
                    ...
                    break;
                case /* SetUpdateProgressIndicatorResponse setUpdateProgressIndicatorResponse */ 4:
                    message.response = {
                        oneofKind: "setUpdateProgressIndicatorResponse",
    ...
    internalBinaryWrite(message: MyAppResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.response.oneofKind === "helloQromaResponse")
            HelloQromaResponse.internalBinaryWrite(message.response.helloQromaResponse, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* MathResponse mathResponse = 2; */
        if (message.response.oneofKind === "mathResponse")
            MathResponse.internalBinaryWrite(message.response.mathResponse, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.response.oneofKind === "setUpdateConfigurationResponse")
            SetUpdateConfigurationResponse.internalBinaryWrite(message.response.setUpdateConfigurationResponse, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.response.oneofKind === "setUpdateProgressIndicatorResponse")
            SetUpdateProgressIndicatorResponse.internalBinaryWrite(message.response.setUpdateProgressIndicatorResponse, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
